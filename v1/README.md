...
- 讲真写这个简历的CSS，真得有点乱写的赶脚……只要效果出来了即可！
...
我知道弄一个三角形，然后再弄很多个三角形，让它们通过flex布局后水平排列即可，可是这三角形未免也太多了吧？话说能不能用CSS把这个元素给复制多份呢？——额，我想了想，我还是到iconfont上下载个三角形的svg好了，然后用背景图的repeat-x即可……

额……试了试还是用多个三角形……反正后面会改，所以先有个效果先！……
